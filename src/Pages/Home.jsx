...
const services = [
  {
    title: "Search",
    description: "Get found by customers who are already looking for you.",
    icon: Search,
    items: [
  ...
  {
    title: "Paid Media",
    description: "Instant visibility with a measurable return on every dollar.",
    icon: Megaphone,
    items: ["Pay Per Click (PPC) Advertising", "Facebook Advertising"],
  },

  {
    title: "Creative",
    description: "A brand and website your customers trust at first glance.",
    icon: Palette,
    items: ["Online Branding", "Website Design"],
  },

  {
    title: "Development",
    description: "Fast, reliable builds engineered to convert visitors.",
    icon: Code2,
    items: [
...
const Home = () => {
          ...
          <div className="max-w-4xl">
            ...
            <ScrollReveal direction="left" delay={100}>
              <h1 className="text-5xl font-black leading-[0.95] tracking-tight text-white sm:text-6xl lg:text-8xl">
                {[
                  ...
                  return (
                    <span key={lineIndex} className={`block ${line.color}`}>
            ...
            <ScrollReveal direction="right" delay={200}>
              <p className="mt-8 max-w-2xl text-base leading-8 text-gray-300 sm:text-lg">
                LeadAxis helps ambitious businesses generate better leads, build
                stronger digital experiences, and turn online attention into
                measurable growth.
              </p>
            </ScrollReveal>
          ...
          <ScrollReveal direction="up">
            <div className="mb-16 max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">
                From search visibility to paid acquisition, creative, websites,
                and applications — LeadAxis brings the pieces together into one
  ...
  className="group h-full rounded-[2rem] border border-gray-200 bg-gray-50 p-7 transition-all duration-500 hover:-translate-y-2 hover:border-lime-200 hover:bg-white hover:shadow-2xl dark:border-gray-800 dark:bg-gray-900 dark:hover:border-lime-900 dark:hover:bg-gray-800 sm:p-9"
>
          ...
          <ScrollReveal direction="left">
            <div className="max-w-3xl">
              ...
              <h2 className="text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl">
                Industry-specific
                <span className="text-gray-500"> lead generation.</span>
              </h2>
          ...
          <ScrollReveal direction="up">
            <div className="mb-16 max-w-3xl">
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-600 dark:text-gray-400">
                Explore selected projects across lead generation, performance
                marketing, website development, and React Native application
                development.
              </p>
            </div>
          </ScrollReveal>
                ...
                <ScrollReveal direction="up" delay={250}>
                  <div className="mx-auto mt-10 max-w-4xl">
                    <p className="text-base leading-8 text-gray-300 sm:text-lg">
                      ...
                      actively searching for the services they need. My
                      experience covers campaign sourcing, traffic generation,
                      call quality, and performance-focused lead acquisition
                    ...
                    <p className="mt-6 text-base leading-8 text-gray-400 sm:text-lg">
                      ...
                      <span className="font-semibold text-gray-200">
                        reliable, scalable, and performance-driven call
                        campaigns
                      </span>{" "}
                      where quality matters as much as volume. From
                      understanding campaign requirements and targeting the
                      right audience to generating relevant inbound calls, my
                      approach is centered around creating valuable connections
                ...
                <ScrollReveal direction="up" delay={300}>
                  <div className="mt-10">
                    ...
                    <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-gray-400 sm:text-base">
                      Let's connect, discuss your campaign requirements, and
                      build a Pay-Per-Call partnership focused on real
        ...
        <div className="mx-auto max-w-7xl">
          <ScrollReveal direction="right">
            <div className="mb-14 max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">
                Different industries require different customer journeys. Our
                strategies are designed around the markets, audiences, and
            ...
            {reviews.map((review, index) => (
              ...
              >
                <article className="h-full rounded-[2rem] border border-gray-200 bg-gray-50 p-7 transition-all duration-500 hover:-translate-y-2 hover:bg-white hover:shadow-xl dark:border-gray-800 dark:bg-gray-900 dark:hover:bg-gray-800">
                  <Quote size={30} className="text-lime-400" />
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] bg-gray-950 px-7 py-16 text-center sm:px-12 sm:py-20">
              ...
              <div className="relative z-10 mx-auto max-w-3xl">
                ...
                <h2 className="mt-6 text-4xl font-black tracking-tight text-white sm:text-5xl lg:text-6xl">
                  Ready to turn leads
                  <span className="block text-lime-300">into growth?</span>
                </h2>

                <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-400">
                  Tell us where your business is today and where you want to
                  take it. We'll help map the digital opportunities between the
                  two.
                </p>
      ...
      >
        <div className="mx-auto max-w-7xl">
            ...
            <ScrollReveal direction="left">
              <div>
                ...
                <p className="mt-5 max-w-xs text-sm leading-7 text-gray-500">
                  Performance-driven lead generation, digital marketing, website
                  development, and mobile application solutions for businesses
                  ready to grow.
                </p>
          ...
          <div className="mt-16 flex flex-col gap-5 border-t border-white/10 pt-8 text-xs text-gray-600 sm:flex-row sm:items-center sm:justify-between">
            <p>© {new Date().getFullYear()} LeadAxis. All rights reserved.</p>
